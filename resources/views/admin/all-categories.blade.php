                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="table-action text-center">
                                    ...
                                    <a onclick="return confirm('Are You Sure You want to Delete This')" href="{{url('deletecategory')}}/{{ $r->id }}" class="action-icon" title="Delte Category"> <i class="mdi mdi-delete"></i></a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
